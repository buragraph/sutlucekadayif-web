import { upsertMetaToplanlar, upsertToplamErisim, getAllSubeler, getSubeByKod, getMetaMappings, saveMetaMappings as dbSaveMetaMappings, getCampaignMappings, saveCampaignMappings as dbSaveCampaignMappings, getAdsetMappings, saveAdsetMappings as dbSaveAdsetMappings, getAdsetsCache, saveAdsetsCache } from '../db.js';

// Eskiden batch sonunda veri versiyonunu artırırdı (cross-instance cache
// doğrulaması). v2'de versiyon kavramı yok — çağrı yerleri korunsun diye
// fonksiyon duruyor, iş yapmıyor.
async function bumpAfterBatch(_kodlar) { /* no-op — bkz. db.js başlığı */ }
