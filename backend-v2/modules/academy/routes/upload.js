...
// Video/PDF yükleme kuralı — ortam bağımsız (bkz. shared/dosya.js)
const DOSYA_AL = dosyaAl('file', {
    tipler: ['video/mp4', 'video/webm', 'video/quicktime', 'application/pdf'],
    enBoy: 100 * 1024 * 1024,
    hataMesaji: 'Sadece MP4, WebM, MOV ve PDF dosyaları yüklenebilir',
});
